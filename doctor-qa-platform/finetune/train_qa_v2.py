...
基座: Qwen2.5-7B-Instruct，4bit LoRA，输出 adapter 到 output/exp-qa-v2/
用法: python train_qa.py
"""
import os, json, sys
os.environ["HF_HUB_DISABLE_XET"] = "1"
os.environ["HF_ENDPOINT"] = "https://hf-mirror.com"
os.environ["UNSLOTH_COMPILE_DISABLE"] = "1"  # Windows 下 torch.compile/dynamo 不稳定（fused loss 图编译崩溃），禁用
...
DATA_FILE = os.path.join(os.path.dirname(__file__), "qa_data", "qa_dataset_v2.jsonl")
OUT_DIR = os.path.join(os.path.dirname(__file__), "output", "exp-qa-v2")
